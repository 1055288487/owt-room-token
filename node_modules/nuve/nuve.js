...
N = N || {};
N.API = function(d) {
    var g = function(b, k, f, g, c, a, r, m, z) {
        if (void 0 === a) {
            var e = d.API.params.service;
            var h = d.API.params.key;
            if(z){
                c = d.API.params.url + c + `?sharpness=${z}`
            }else{
            c = d.API.params.url + c
            }
        } else {
            if(z){
                e = a.service, h = a.key, c = a.url + c + `?sharpness=${z}`;
            }
                e = a.service, h = a.key, c = a.url + c;}
    ...
    return {
        ...
        // createToken: function(b, d, f, h, e, c, a) {
         
        //     g(h, c, "POST", void 0, "rooms/" + b + "/tokens", a, d, f, e)
        // },
        createToken: function(b, d, f, h, c, a, z) {
            g(h, c, "POST", void 0, "rooms/" + b + "/tokens", a, d, f, z)
        },
